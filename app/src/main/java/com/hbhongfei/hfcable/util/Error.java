...
public class Error {
    ...
    public static void toSetting(LinearLayout noInternet, int img_item, String text_item1, String text_item2, final IErrorOnclick errorOnclick) {
        ImageView img;
        TextView text1;
        TextView text2;//com.android.volley.NoConnectionError

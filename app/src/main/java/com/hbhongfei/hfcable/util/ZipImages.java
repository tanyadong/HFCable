...
/**
 * Created by 压缩图片 on 2016/10/1.
 */
public class ZipImages {
     ...
     * @return 字符串
     */
    public static String getimageOfString(String srcPath) {
        ...
        return compressImageToString(bitmap);//压缩好比例大小后再进行质量压缩
    }
     ...
     * @return bitmap
     */
    public static Bitmap getImageOfBitmap(String srcPath) {
        BitmapFactory.Options newOpts = new BitmapFactory.Options();
        //开始读入图片，此时把options.inJustDecodeBounds 设回true了
        newOpts.inJustDecodeBounds = true;
        Bitmap bitmap = BitmapFactory.decodeFile(srcPath,newOpts);//此时返回bm为空
    ...
    public static String compressImage(String filePath, String targetPath, int quality)  {
        ...
        Bitmap bm = getImageOfBitmap(filePath);//获取一定尺寸的图片

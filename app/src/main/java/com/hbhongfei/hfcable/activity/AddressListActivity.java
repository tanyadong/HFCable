...
public class AddressListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initValues(){
        ...
        //获取地址
        ShoppingAddressListConnection shoppingAddressListConnection=new ShoppingAddressListConnection(this,S_phoneNumber,this,lview_recriptAddress,layout_address_emity);

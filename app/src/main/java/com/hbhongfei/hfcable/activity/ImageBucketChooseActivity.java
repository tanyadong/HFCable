...
import com.hbhongfei.hfcable.adapter.ImageBucketAdapter;
import com.hbhongfei.hfcable.pojo.ImageBucket;
import com.hbhongfei.hfcable.util.CustomConstants;
import com.hbhongfei.hfcable.util.ImageFetcher;
    ...
    private void initView() {
        ...
        cancelTv.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ImageBucketChooseActivity.this,WriteCableRingActivity.class);
                startActivity(intent);
                finish();
            }
        });

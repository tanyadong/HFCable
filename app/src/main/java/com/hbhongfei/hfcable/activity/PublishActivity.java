...
public class PublishActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(PublishActivity.this, "PublishActivity", Toast.LENGTH_SHORT).show();
        initData();
        initView();
    }
...
//                removeTempFromPref();
//                System.exit(0);
                Toast.makeText(PublishActivity.this,mDataList.toString(),Toast.LENGTH_SHORT).show();

...
import com.hbhongfei.hfcable.util.ImageScaleView;
import com.hbhongfei.hfcable.util.CropBorderView;
...
public class CropImageView extends RelativeLayout {
    ...
    public CropImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCropBorderView = new com.hbhongfei.hfcable.util.CropBorderView(context);

...
public class CommentAdapter extends BaseAdapter {
    ...
    public CommentAdapter(Context context, List<Map<String, Object>> list/* , TextView comment,EditText commentContent, InputMethodManager imm, LinearLayout linear, RelativeLayout Rcomment, FloatingActionButton btn, String id, String phone*/) {
